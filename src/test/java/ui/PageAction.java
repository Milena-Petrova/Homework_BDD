...
public class PageAction {
    ...
    /**
     * @param element    warehouse button
     * @param name visible text of the button
     */
    public void clickButton(WebElement element, String name) {
        Validate.notNull(element, "Element should not be null");
    ...
    /**
     * This method make the browser waiting until web element appears
     * @param by web element
     */

    public boolean waitUntilVisible(By by,String auto) {
       WebDriverWait wait = new WebDriverWait(driver,20);
        return wait.until(ExpectedConditions.textToBe(by, auto));
    }
}
